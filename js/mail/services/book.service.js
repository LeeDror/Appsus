...
function getGoogleBooks(searchStr) {
  //const KEY = '998238944be226c86c563125d072b417';
  return axios
    .get(
      `https://www.googleapis.com/books/v1/volumes?printType=books&q=${searchStr}&maxResults=8`
    )
...
function addGoogleBook(book) {
  var newBook = {
    ...
    listPrice: {
      amount: 100, //book.saleInfo.listPrice.amount,
...
function addReview(bookId, review) {
  ...
  book.reviews[book.reviews.length] = review;
}
