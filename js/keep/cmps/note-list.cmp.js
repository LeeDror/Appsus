...
export default {
  ...
  template: `
        <section class="note-list">
            <div class="note-preview flex-column space-between" v-for="(note, idx) in notes" :style="note.style" @mouseover="showBtnBar(note.id)" @mouseout="showBtnBar(note.id)">
                <component :is="note.type" :note="note" @setVal="setNote($event, idx)" ></component>
                <div class="showBar" v-show="currNote===note.id">
